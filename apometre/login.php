...
/*
fisier de prelucrare a datelor din login_form.php
...
if ($counter ==1){
	//sa tin minte ca e logat, adica sa nu tb sa se logheze de fiecare data cand apeleaza diferite pagini
	...
	echo "Apasa <a href='login_form.php'>aici</a> pentru a reincerca";
}
